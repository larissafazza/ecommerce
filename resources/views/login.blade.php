    ...
    <body>
        <div class="login-box">
            ...
            <form>
                ...
                <div>
                    <button type="button" class="login-button vendedor">Entrar como vendedor</button>
                </div>
                <div>
                    <button type="button" class="login-button cliente">Entrar como cliente</button>
                </div>
                <a href="#" class="cadastro"><span>Quero me cadastrar</span></a>
            </form>
            </div>
            </div>
        </div>
